...
<div class="overlay" id="popUpHistorico" tabindex="-1">
<a class="cancel" href="#"></a>
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenteredScrollableTitle">Histórico Pop Up</h5>
                ...
                <div class="modal-footer">
                    <a type="button" onclick="goBack()" class="btn btn-secondary">Close</a>
                </div>
            </div>
        </div>
    </div>
